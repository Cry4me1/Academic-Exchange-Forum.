...
import { ArrowLeft, Ban, CheckCircle, Clock, FileText, Loader2, MessageSquare, Shield, ShieldAlert, User, VolumeX, ExternalLink } from "lucide-react";
          ...
          <CardHeader className="text-center pb-2">
            ...
            <CardDescription className="flex flex-col items-center gap-1 mt-1">
              ...
              <div className="flex items-center gap-2 mt-2">
                <Badge variant={profile.is_banned ? "destructive" : profile.is_muted ? "secondary" : "default"} className={profile.is_muted && !profile.is_banned ? "bg-amber-500 hover:bg-amber-600 text-white border-transparent" : (!profile.is_banned && !profile.is_muted ? "bg-emerald-500 hover:bg-emerald-600" : "")}>
                  {profile.is_banned ? "已封禁" : profile.is_muted ? "已禁言" : "状态正常"}
                </Badge>
