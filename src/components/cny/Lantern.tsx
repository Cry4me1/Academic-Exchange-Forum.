    ...
    return (
        ...
        >
            <div className="flex flex-col items-center animate-float origin-top">
                {/* String */}
                <div className="w-0.5 h-24 bg-yellow-500/50"></div>

                {/* Lantern Body */}
                <div className="relative w-16 h-20 bg-gradient-to-b from-red-700 to-red-900 rounded-lg shadow-lg flex items-center justify-center border-t-4 border-b-4 border-yellow-500">
                    {/* Glow effect inside */}
                    <div className="absolute inset-0 bg-red-500 opacity-20 blur-md rounded-lg animate-pulse"></div>
                    <span className="text-yellow-400 font-serif font-bold text-2xl drop-shadow-md">{text}</span>
                </div>
